 ...
 * 1) Set a break point in GoApigenServerGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class GoApigenServerGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("go-apigen-server") // use this codegen library
              ...
              .setOutputDir("out/go-apigen-server"); // output directory
