...
func NewNumericTypesArrayItemsParamsValidator() FieldValidator[*NumericTypesArrayItemsParams] {
	...
	validatePayload := NewObjectFieldValidator(
		...
		NewNumericTypesArrayItemsRequestValidator(),
	)
	
	return func(bindingCtx *BindingContext, value *NumericTypesArrayItemsParams) {
