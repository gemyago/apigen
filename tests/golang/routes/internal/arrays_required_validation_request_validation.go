...
func NewArraysRequiredValidationRequestValidator() FieldValidator[*models.ArraysRequiredValidationRequest] {
	...
	return func(bindingCtx *BindingContext, value *models.ArraysRequiredValidationRequest) {
