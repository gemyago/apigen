...
func NewSimpleObjectsContainerValidator(params ModelValidatorParams) FieldValidator[*models.SimpleObjectsContainer] {
	...
	validateSimpleNullableObject1 := NewSimpleNullableObjectValidator(ModelValidatorParams{Location: params.Location + ".simpleNullableObject1"})
	validateSimpleNullableObject2 := NewSimpleNullableObjectValidator(ModelValidatorParams{Location: params.Location + ".simpleNullableObject2"})
	validateOptionalSimpleObject1 := NewSimpleObjectValidator(ModelValidatorParams{Location: params.Location + ".optionalSimpleObject1"})
	validateOptionalSimpleObject2 := NewSimpleObjectValidator(ModelValidatorParams{Location: params.Location + ".optionalSimpleObject2"})
	validateOptionalNullableSimpleObject1 := NewSimpleNullableObjectValidator(ModelValidatorParams{Location: params.Location + ".optionalNullableSimpleObject1"})
	validateOptionalNullableSimpleObject2 := NewSimpleNullableObjectValidator(ModelValidatorParams{Location: params.Location + ".optionalNullableSimpleObject2"})
