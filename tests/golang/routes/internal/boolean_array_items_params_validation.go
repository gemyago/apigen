...
func NewBooleanArrayItemsParamsValidator() FieldValidator[*BooleanArrayItemsParams] {
	...
	validatePayload := NewObjectFieldValidator(
		...
		NewBooleanArrayItemsRequestValidator(),
	)
	
	return func(bindingCtx *BindingContext, value *BooleanArrayItemsParams) {
