...
// StringTypesNullableParsingParams - Parameters for the stringTypesNullableParsing operation
type StringTypesNullableParsingParams struct { 
	...
	Payload *StringTypesNullableParsingRequest `json:"payload,omitempty"`
}
