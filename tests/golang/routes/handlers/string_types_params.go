...
type paramsParserStringTypesArraysNullableRequiredValidation struct {
...
func (p *paramsParserStringTypesArraysNullableRequiredValidation) parse(router httpRouter, req *http.Request) (*StringTypesArraysNullableRequiredValidationRequest, error) {
	bindingCtx := internal.BindingContext{}
	reqParams := &StringTypesArraysNullableRequiredValidationRequest{}
	// path params
...
func newParamsParserStringTypesArraysNullableRequiredValidation(app *HTTPApp) paramsParser[*StringTypesArraysNullableRequiredValidationRequest] {
	return &paramsParserStringTypesArraysNullableRequiredValidation{
...
func (p *paramsParserStringTypesArraysRequiredValidation) parse(router httpRouter, req *http.Request) (*StringTypesArraysRequiredValidationRequest, error) {
	bindingCtx := internal.BindingContext{}
	reqParams := &StringTypesArraysRequiredValidationRequest{}
	// path params
	pathParamsCtx := bindingCtx.Fork("path")
	p.bindSimpleItems1(pathParamsCtx.Fork("simpleItems1"), readPathValue("simpleItems1", router, req), &reqParams.SimpleItems1)
	p.bindSimpleItems2(pathParamsCtx.Fork("simpleItems2"), readPathValue("simpleItems2", router, req), &reqParams.SimpleItems2)
...
func newParamsParserStringTypesArraysRequiredValidation(app *HTTPApp) paramsParser[*StringTypesArraysRequiredValidationRequest] {
	return &paramsParserStringTypesArraysRequiredValidation{
		bindSimpleItems1: newRequestParamBinder(binderParams[string, []string]{
			required: true,
			parseValue: parseSoloValueParamAsSlice(
				app.knownParsers.stringParser,
