...
func newParamsParserNumericTypesNumericTypesNullable(app *HTTPApp) paramsParser[*NumericTypesNumericTypesNullableRequest] {
	return &paramsParserNumericTypesNumericTypesNullable{
		bindNumberAny: newRequestParamBinder(binderParams[string, *float32]{
			...
			location: "path",
			required: true,
			parseValue: parseSingleValueParamAsSingleValue(parseNullableParam(app.knownParsers.float32Parser)),
		...
		bindNumberDouble: newRequestParamBinder(binderParams[string, *float64]{
			...
			location: "path",
			required: true,
			parseValue: parseSingleValueParamAsSingleValue(parseNullableParam(app.knownParsers.float64Parser)),
		...
		bindNumberInt: newRequestParamBinder(binderParams[string, *int32]{
			...
			location: "path",
			required: true,
			parseValue: parseSingleValueParamAsSingleValue(parseNullableParam(app.knownParsers.int32Parser)),
		...
		bindNumberInt64: newRequestParamBinder(binderParams[string, *int64]{
			...
			location: "path",
			required: true,
			parseValue: parseSingleValueParamAsSingleValue(parseNullableParam(app.knownParsers.int64Parser)),
		...
		bindNumberAnyInQuery: newRequestParamBinder(binderParams[[]string, *float32]{
			...
			location: "query",
			required: true,
			parseValue: parseMultiValueParamAsSingleValue(parseNullableParam(app.knownParsers.float32Parser)),
			validateValue: internal.NewSimpleFieldValidator[*float32](
		...
		bindNumberDoubleInQuery: newRequestParamBinder(binderParams[[]string, *float64]{
			...
			location: "query",
			required: true,
			parseValue: parseMultiValueParamAsSingleValue(parseNullableParam(app.knownParsers.float64Parser)),
			validateValue: internal.NewSimpleFieldValidator[*float64](
		...
		bindNumberIntInQuery: newRequestParamBinder(binderParams[[]string, *int32]{
			...
			location: "query",
			required: true,
			parseValue: parseMultiValueParamAsSingleValue(parseNullableParam(app.knownParsers.int32Parser)),
			validateValue: internal.NewSimpleFieldValidator[*int32](
		...
		bindNumberInt64InQuery: newRequestParamBinder(binderParams[[]string, *int64]{
			...
			location: "query",
			required: true,
			parseValue: parseMultiValueParamAsSingleValue(parseNullableParam(app.knownParsers.int64Parser)),
			validateValue: internal.NewSimpleFieldValidator[*int64](
		...
		bindPayload: newRequestParamBinder(binderParams[*http.Request, *models.NumericTypesNullableRequest]{
			...
			location: "body",
			required: true,
			parseValue: parseSingleValueParamAsSingleValue(parseJSONPayload[*models.NumericTypesNullableRequest]),
...
func newParamsParserNumericTypesNumericTypesParsing(app *HTTPApp) paramsParser[*NumericTypesNumericTypesParsingRequest] {
	return &paramsParserNumericTypesNumericTypesParsing{
		...
		bindNumberDouble: newRequestParamBinder(binderParams[string, float64]{
			...
			location: "path",
			required: true,
			parseValue: parseSingleValueParamAsSingleValue(app.knownParsers.float64Parser),
			validateValue: internal.NewSimpleFieldValidator[float64](
		...
		bindNumberInt: newRequestParamBinder(binderParams[string, int32]{
			...
			location: "path",
			required: true,
			parseValue: parseSingleValueParamAsSingleValue(app.knownParsers.int32Parser),
			validateValue: internal.NewSimpleFieldValidator[int32](
		...
		bindNumberInt64: newRequestParamBinder(binderParams[string, int64]{
			...
			location: "path",
			required: true,
			parseValue: parseSingleValueParamAsSingleValue(app.knownParsers.int64Parser),
			validateValue: internal.NewSimpleFieldValidator[int64](
		...
		bindNumberDoubleInQuery: newRequestParamBinder(binderParams[[]string, float64]{
			...
			location: "query",
			required: true,
			parseValue: parseMultiValueParamAsSingleValue(app.knownParsers.float64Parser),
			validateValue: internal.NewSimpleFieldValidator[float64](
		...
		bindNumberIntInQuery: newRequestParamBinder(binderParams[[]string, int32]{
			...
			location: "query",
			required: true,
			parseValue: parseMultiValueParamAsSingleValue(app.knownParsers.int32Parser),
			validateValue: internal.NewSimpleFieldValidator[int32](
		...
		bindNumberInt64InQuery: newRequestParamBinder(binderParams[[]string, int64]{
			...
			location: "query",
			required: true,
			parseValue: parseMultiValueParamAsSingleValue(app.knownParsers.int64Parser),
			validateValue: internal.NewSimpleFieldValidator[int64](
		...
		bindPayload: newRequestParamBinder(binderParams[*http.Request, *models.NumericTypesParsingRequest]{
			...
			location: "body",
			required: true,
			parseValue: parseSingleValueParamAsSingleValue(parseJSONPayload[*models.NumericTypesParsingRequest]),
...
func newParamsParserNumericTypesNumericTypesRangeValidation(app *HTTPApp) paramsParser[*NumericTypesNumericTypesRangeValidationRequest] {
	return &paramsParserNumericTypesNumericTypesRangeValidation{
		...
		bindPayload: newRequestParamBinder(binderParams[*http.Request, *models.NumericTypesRangeValidationRequest]{
			...
			location: "body",
			required: true,
			parseValue: parseSingleValueParamAsSingleValue(parseJSONPayload[*models.NumericTypesRangeValidationRequest]),
...
func newParamsParserNumericTypesNumericTypesRangeValidationExclusive(app *HTTPApp) paramsParser[*NumericTypesNumericTypesRangeValidationExclusiveRequest] {
	return &paramsParserNumericTypesNumericTypesRangeValidationExclusive{
		...
		bindPayload: newRequestParamBinder(binderParams[*http.Request, *models.NumericTypesRangeValidationExclusiveRequest]{
			...
			location: "body",
			required: true,
			parseValue: parseSingleValueParamAsSingleValue(parseJSONPayload[*models.NumericTypesRangeValidationExclusiveRequest]),
