...
func TestBoolean(t *testing.T) {
	...
	t.Run("parsing", func(t *testing.T) {
		randomReq := func() *models.BooleanBooleanParsingParams {
			return &models.BooleanBooleanParsingParams{
				// path
		...
		buildQuery := func(wantReq *models.BooleanBooleanParsingParams) url.Values {
			query := url.Values{}
	...
	t.Run("required-validation", func(t *testing.T) {
		buildQuery := func(wantReq *models.BooleanBooleanRequiredValidationParams) url.Values {
			query := url.Values{}
			query.Add("boolParam1InQuery", strconv.FormatBool(wantReq.BoolParam1InQuery))
			query.Add("boolParam2InQuery", strconv.FormatBool(wantReq.BoolParam2InQuery))
		...
		runRouteTestCase(t, "should ignore missing optional params", setupRouter, func() testCase {
			wantReq := &models.BooleanBooleanRequiredValidationParams{
				// query
				BoolParam1InQuery: fake.Bool(),
				BoolParam2InQuery: fake.Bool(),
	...
	t.Run("nullable", func(t *testing.T) {
		randomReq := func() *models.BooleanBooleanNullableParams {
			return &models.BooleanBooleanNullableParams{
				// path
		...
		buildQuery := func(wantReq *models.BooleanBooleanNullableParams) url.Values {
			query := url.Values{}
		...
		runRouteTestCase(t, "should accept null values", setupRouter,
			func() routeTestCase[*booleanControllerTestActions] {
				wantReq := &models.BooleanBooleanNullableParams{
					Payload: &models.BooleanNullableRequest{},
				}
				query := url.Values{}
	...
	t.Run("array-items", func(t *testing.T) {
		randomReq := func() *models.BooleanBooleanArrayItemsParams {
			return &models.BooleanBooleanArrayItemsParams{
				// path
		...
		buildQuery := func(wantReq *models.BooleanBooleanArrayItemsParams) url.Values {
			query := url.Values{}
		...
		buildPath := func(wantReq *models.BooleanBooleanArrayItemsParams) string {
	...
	t.Run("nullable-array-items", func(t *testing.T) {
		randomReq := func(
			opts ...func(*models.BooleanBooleanNullableArrayItemsParams),
		) *models.BooleanBooleanNullableArrayItemsParams {
			res := &models.BooleanBooleanNullableArrayItemsParams{
				// path
		...
		buildQuery := func(wantReq *models.BooleanBooleanNullableArrayItemsParams) url.Values {
			query := url.Values{}
		...
		buildPath := func(wantReq *models.BooleanBooleanNullableArrayItemsParams) string {
		...
		runRouteTestCase(t, "should parse and bind valid null values", setupRouter,
			func() routeTestCase[*booleanControllerTestActions] {
				wantReq := randomReq(func(req *models.BooleanBooleanNullableArrayItemsParams) {
