...
//
// In order to register routes, please use methods below:
// - RegisterAllRoutes to register all routes at once.
// - RegisterPetsRoutes to register routes for pets controller.
